...
function ProductForm() {
    ...
    const handleAddData = (data) => {
        ...
        if (l_product === null) {
            localStorage.setItem("_products", JSON.stringify([newData]))
            setData([newData])
        } else {
            l_product.push(newData)
            localStorage.setItem("_products", JSON.stringify(l_product))
            setData(l_product)
        }
    }
                    ...
                    <div className='col-5'>
                        <div className='part_block'>
                            ...
                            <div className="form_field position-relative p-4" >
                                {/* <TextField className='m-0' size='small' id="image" label="Product image" type="file" fullWidth name='image' variant="outlined"
                                            style={{ display: 'none' }} /> */}
                                <div id='productImage'>
