                        ...
                        <div className="col-lg-5">
                            <div className="sb-contact-form-frame">
                                <div className="sb-illustration-9">
                                    <img src="assets/img/illustrations/envelope-1.png" alt="envelope" className="sb-envelope-1" />
                                    <img src="assets/img/illustrations/envelope-2.png" alt="envelope" className="sb-envelope-2" />
                                ...
                                <div className="sb-form-content">
                                    ...
                                    <div className="sb-success-result">
                                        ...
                                        {/* button */}
                                        <Link to="/home" className="sb-btn sb-btn-2">
